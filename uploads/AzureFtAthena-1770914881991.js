...
user.limit += 3
let ini_txt = `
_*🎉Selamat Ya, Kamu Naik Level🎉*_

•> *⊰⁠⊹ Level :* ~${before}~ --> *${user.level}*
•> *⊰⁠⊹ Role :* ${iyaa}
•> *⊰⁠⊹ Reward :* +1.000.000 Money
•> *⊰⁠⊹ Bonus :* +3 Limit

_Semakin Sering kamu Berinteraksi Dengan ${global.namebot} Semakin Tinggi Pula Level Kamu_`.trim()
		 this.sendFile(m.chat, 'https://files.catbox.moe/10qt6b.jpg', '', ini_txt, m)
	}
}
